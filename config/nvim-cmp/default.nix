  ...
  plugins.cmp = {
    ...
    settings = {
      ...
      mapping = {
        ...
        #
        # This collides with my motions between buffers, so for now i is removed
        # AAAH! But this expand_or_jump is needed to expand hidden snippets, uff
        # "<C-l>" = ''
        #    uasnip = require('luasnip')
