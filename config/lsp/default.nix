...
let
  cfg = config.my.options.lsp;
in
{
  options.my.options.lsp = {
    full = mkEnableOption "";
  };
  ...
  config = {
    ...
    plugins.lsp = {
      ...
      servers = {
        clangd.enable = cfg.full; # C, C++
        rust_analyzer = {
          enable = cfg.full; # Rust
          installCargo = true;
          installRustc = true;
        };
        gopls.enable = cfg.full; # Go
        pyright.enable = cfg.full; # Python

        hls = {
          enable = cfg.full; # Haskell
          installGhc = true;
        };
        ...
        vtsls.enable = cfg.full; # Javascript, Typescript
        ...
        texlab.enable = cfg.full; # LaTeX
        tinymist.enable = cfg.full; # Typst
      };
